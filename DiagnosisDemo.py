...
class DiagnosisDemo:
    ...
    def __init__(self):
        ...
        self._diagnosisClient = DiseaseDiagnosis.DiseaseDiagnosis(username, password, authUrl, language, healthUrl)
    ...
    def _loadSublocationSymptoms(self, subLocId):
        symptoms = self._diagnosisClient.loadSublocationSymptoms(subLocId, "Man")
    ...
    def _loadDiagnosis(self, selectedSymptoms):
        ...
        diagnosis = self._diagnosisClient.loadDiagnosis(selectedSymptomsIds, DiseaseDiagnosis.Gender.Male, 1988)
    ...
    def _loadSpecialisations(self, selectedSymptoms):
        ...
        specialisations = self._diagnosisClient.loadSpecialisations(selectedSymptomsIds,
                                                                    DiseaseDiagnosis.Gender.Male, 1988)
...
diagnosisClientDemo = DiagnosisDemo()
#diagnosisClientDemo.simulate()

#diagnosisClientDemo._loadSublocationSymptoms(34)

print (diagnosisClientDemo._loadDiagnosis([234, 235, 236]))
